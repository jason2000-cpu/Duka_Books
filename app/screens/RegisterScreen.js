    ...
    return (
        <View style={styles.container}>
           ...
           <View style={styles.form_sec}>
              <Text style={{ fontSize: 25, fontWeight:'bold', color: Colors.primary ,marginLeft:130, marginBottom: 40}}>SIGNUP</Text>
            <View style={styles.form}>
                    ...
                    <View style={{marginBottom: 9}}>
                        <Text style={{marginBottom: 4,fontSize:20}}>Email</Text>
                        <TextInput  style={{paddingLeft: 9, borderWidth:2, borderRadius: 5, borderColor:Colors.primary}} placeholder='email'/>
                    </View>
                    <View style={{marginBottom: 9}}>
                        <Text  style={{marginBottom: 4,fontSize:20}}>Phone No</Text>
                        <TextInput  style={{paddingLeft: 9, borderWidth:2, borderRadius: 5, borderColor:Colors.primary}} placeholder='username'/>
                    </View>
                    <View style={{marginBottom: 9}}>
                        <Text style={{marginBottom: 4,fontSize:20}}>Password</Text>
                        <TextInput  style={{paddingLeft: 9, borderWidth:2, borderRadius: 5, borderColor:Colors.primary}} placeholder='password'/>
                    </View>
                    <View style={{marginBottom: 9}}>
                        <Text style={{marginBottom: 4, fontSize: 20}}>Password</Text>
